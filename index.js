...
class LinkParser {
	 ...
	 * @param {string} [options.defaultCommand]
	 ...
	 */
	constructor(options) {
		this.options = LinkParser.applyDefaultOptions(options);
	...
	static applyDefaultOptions(userOptions) {
		return Object.assign({}, LinkParser.defaultOptions, userOptions);
	}
}
 ...
 * @param {LinkToken & {[key: string]: any}} link
